...
def run_caffe():
    ...
    for i in interpreters:
        prepare_ipynb(i, '/home/{}/test_templates/template_caffe.ipynb'.format(args.os_user),
                      'caffe')
        run_ipynb('caffe')
...
def run_caffe2():
    interpreters = ['pyspark_local']
    for i in interpreters:
        prepare_ipynb(i, '/home/{}/test_templates/template_caffe2.ipynb'.format(args.os_user),
                      'caffe2')
        run_ipynb('caffe2')
