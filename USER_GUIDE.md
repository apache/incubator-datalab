...
To do this, simply click on icon <img src="doc/filter_icon.png" alt="filter" width="7" style='transform: translateY(2px);'> in dashboard header and filter your list by any of:
...
Once your list of filtered by any of the columns, icon <img src="doc/filter_icon.png" alt="filter" width="7" style='transform: translateY(2px);'> changes to <img src="doc/sort_icon.png" alt="filter" width="16"> for a filtered columns only.
