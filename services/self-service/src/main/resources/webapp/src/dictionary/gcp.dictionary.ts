...
export const NAMING_CONVENTION = {
  ...
  'docker.dlab-dataengine-service': {
      'total_instance_number_min': 'min_dataproc_master_instance_count',
      'total_instance_number_max': 'max_dataproc_master_instance_count',
      'total_slave_instance_number_min': 'min_dataproc_slave_instance_count',
      'total_slave_instance_number_max': 'max_dataproc_slave_instance_count',
      'min_emr_spot_instance_bid_pct': 'min_emr_spot_instance_bid_pct',
      'max_emr_spot_instance_bid_pct': 'max_emr_spot_instance_bid_pct',
      'data_engine_master_instance_size': 'Master machine type',
      'data_engine_slave_instance_size': 'Slave machine type',
      'instance_number': 'Total master machine number',
      'master_instance_number': 'Total master machine number',
      'slave_instance_number': 'Total slave machine number',
      'master_node_shape': 'master_node_shape',
      'slave_node_shape': 'slave_node_shape',
