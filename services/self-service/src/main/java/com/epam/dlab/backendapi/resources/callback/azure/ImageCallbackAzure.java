...
@Slf4j
public class ImageCallbackAzure extends ImageCallback {
    ...
    public Response imageCreateStatus(ImageCreateStatusDTO dto) {
        ...
        imageExploratoryService.updateImage(getImage(dto), dto.getImageCreateDTO().getIp(), dto.getExploratoryName());
