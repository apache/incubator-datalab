...
public class ColumnMeta {
	 ...
	 */
	public static int getColumnIndexByName(String columnName, List<String> columnNames) throws InitializationException {
	...
	private Map<String, String> getSourceToTarget(String columnMappingString, List<String> sourceColumnNames) throws InitializationException {
	    ...
	    for (String entry : entries) {
	    	...
	    	try {
	    		...
	    		if (sourceColumnNames == null) {
	    			throw new InitializationException("Invalid column index \"" + pair[1] + "\" or column header not defined");
	    		}
