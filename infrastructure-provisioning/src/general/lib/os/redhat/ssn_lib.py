                ...
                params = '--cloud_provider {} --infrastructure_tag {} --tag_resource_id {} --account_id {} \
                    --billing_bucket {} --aws_job_enabled {} --report_path "{}" --mongo_password {} --dlab_dir {} \
                         ...
                         --cost {} --resource_id {} --tags {}'.\
                            format(cloud_provider, service_base_name, tag_resource_id, account_id,
                                   billing_bucket, aws_job_enabled, report_path,
                                   mongo_passwd, dlab_path, authentication_file, offer_number,
                                   currency, locale, region_info, dlab_id, usage_date,
                                   product, usage_type, usage, cost, resource_id, tags)
