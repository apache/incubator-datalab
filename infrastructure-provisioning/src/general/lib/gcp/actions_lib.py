...
class GCPActions:
    ...
    def create_instance(self, instance_name, service_id_base, cluster_name, region, zone, vpc_name, subnet_name, instance_size,
                        ssh_key_path,
    ...
    def remove_service_account(self, service_account_name, service_id_base):
        unique_index = meta_lib.GCPMeta().get_index_by_service_account_name(service_account_name)
        service_account_email = "{}-{}@{}.iam.gserviceaccount.com".format(service_id_base, unique_index, self.project)
        ...
        try:
            result = request.execute()
            service_account_removed = meta_lib.GCPMeta().get_service_account(service_account_name, service_id_base)
    ...
    def create_service_account(self, service_account_name, service_id_base, unique_index):
        service_account_id = service_id_base + '-' + unique_index
        ...
        try:
            result = request.execute()
            service_account_created = meta_lib.GCPMeta().get_service_account(service_account_name, service_id_base)
    ...
    def set_role_to_service_account(self, service_account_name, role_name, service_id_base, role_type='custom'):
    ...
    def set_service_account_to_instance(self, service_account_name, instance_name, service_id_base):
        unique_index = meta_lib.GCPMeta().get_index_by_service_account_name(service_account_name)
        service_account_email = "{}-{}@{}.iam.gserviceaccount.com".format(service_id_base, unique_index, self.project)
        params = {
            "email": service_account_email
    ...
    def set_bucket_owner(self, bucket_name, service_account_name, service_id_base):
        try:
            unique_index = meta_lib.GCPMeta().get_index_by_service_account_name(service_account_name)
            service_account_email = "{}-{}@{}.iam.gserviceaccount.com".format(service_id_base, unique_index,
                                                                                  self.project)
            bucket = self.storage_client.get_bucket(bucket_name)
