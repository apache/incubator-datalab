...
if __name__ == "__main__":
    ...
    try:
        ...
        params = "--hostname {} --keyfile {} --dlab_path {} --os_user {} --os_family {} --request_id {} --resource {}" \
                 " --service_base_name {} --tag_resource_id {} --cloud_provider {} --account_id {}" \
                 " --billing_bucket {} --aws_job_enabled {} --report_path '{}' --billing_enabled {} --mongo_parameters '{}'" \
                 " --dlab_id '{}' --usage_date {} --product {} --usage_type {} --usage {} --cost {} --resource_id {} --tags {}". \
            format(instance_hostname, "{}{}.pem".format(os.environ['conf_key_dir'], os.environ['conf_key_name']),
                   ...
                   os.environ['aws_billing_bucket'], os.environ['aws_job_enabled'], os.environ['aws_report_path'],
                   billing_enabled, json.dumps(mongo_parameters), os.environ['dlab_id'], os.environ['usage_date'],
                   os.environ['product'], os.environ['usage_type'], os.environ['usage'],
                   os.environ['cost'], os.environ['resource_id'], os.environ['tags'])
