...
if __name__ == "__main__":
    ...
    print('SSH access (from Edge node, via IP address): ssh -i {}.pem {}@{}'.format(notebook_config['key_name'],
                                                                                    notebook_config['dlab_ssh_user'],
                                                                                    ip_address))
    print('SSH access (from Edge node, via FQDN): ssh -i {}.pem {}@{}'.format(notebook_config['key_name'],
                                                                              notebook_config['dlab_ssh_user'],
                                                                              dns_name))
