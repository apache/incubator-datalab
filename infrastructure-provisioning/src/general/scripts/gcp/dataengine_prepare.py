...
if __name__ == "__main__":
    ...
    try:
        ...
        params = "--instance_name {} --region {} --zone {} --vpc_name {} --subnet_name {} --instance_size {} --ssh_key_path {} --initial_user {} --service_account_name {} --ami_name {} --instance_class {} --primary_disk_size {} --gpu_accelerator_type {} --network_tag {}".\
