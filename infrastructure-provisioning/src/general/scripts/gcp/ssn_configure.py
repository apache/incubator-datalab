...
if __name__ == "__main__":
    ...
    try:
        ...
        params = "--hostname {} --keyfile {} --pip_packages 'boto3 argparse fabric==1.14.0 awscli pymongo pyyaml oauth2client google-api-python-client google-cloud-storage pycrypto' --user {} --region {}". \
