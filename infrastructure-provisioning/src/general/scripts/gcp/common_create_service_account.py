...
parser.add_argument('--service_id_base', type=str, default='')
args = parser.parse_args()


if __name__ == "__main__":
    if args.service_account_name != '':
        if GCPMeta().get_service_account(args.service_account_name, args.service_id_base):
            ...
            GCPActions().create_service_account(args.service_account_name, args.service_id_base, args.unique_index)
            ...
            GCPActions().set_role_to_service_account(args.service_account_name, args.role_name, args.service_id_base)
            if args.roles_path != '':
                ...
                for role in predefined_roles:
                    GCPActions().set_role_to_service_account(args.service_account_name, role, args.service_id_base, 'predefined')
    else:
        parser.print_help()
        sys.exit(2)
