...
if __name__ == "__main__":
    ...
    try:
        ...
        ssn_conf['ssn_storage_account_name'] = (ssn_conf['service_base_name'] + 'ssn').lower().replace('-', '')
        ssn_conf['ssn_container_name'] = (ssn_conf['service_base_name'] + '-ssn-container').lower()
        ssn_conf['shared_storage_account_name'] = (ssn_conf['service_base_name'] + 'shared').lower().replace('-', '')
    ...
    try:
        ...
        params = "--container_name {} --account_name {} --resource_group_name {} --region {}". \
                 format(ssn_conf['ssn_container_name'], ssn_conf['ssn_storage_account_name'],
        ...
        try:
            ...
            print "SSN Storage account hasn't been created."
    ...
    try:
        ...
        params = "--container_name {} --account_name {} --resource_group_name {} --region {}". \
                 format(ssn_conf['shared_container_name'], ssn_conf['shared_storage_account_name'],
                        os.environ['azure_resource_group_name'], ssn_conf['region'])
        try:
            local("~/scripts/{}.py {}".format('common_create_container', params))
        except:
    ...
    try:
        ...
        params = "--instance_name {} --instance_size {} --region {} --vpc_name {} --network_interface_name {} --security_group_name {} --subnet_name {} --service_base_name {} --resource_group_name {} --dlab_ssh_user_name {} --public_ip_name {} --public_key '''{}''' --primary_disk_size {} --instance_type {} --instance_storage_account_type {}".\
            format(ssn_conf['instance_name'], os.environ['azure_ssn_instance_size'], ssn_conf['region'], os.environ['azure_vpc_name'],
                   ...
                   ssn_conf['instance_storage_account_type'])
        try:
