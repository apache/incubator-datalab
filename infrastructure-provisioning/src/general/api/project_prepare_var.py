...
if __name__ == "__main__":
    local_log_filename = "{}_{}_{}.log".format(os.environ['conf_resource'], os.environ['project_tag'],
    ...
    project_conf['admin_keyname'] = os.environ['project_admin_name']
    ...
    project_conf['edge_instance_name'] = '{}-{}-edge'.format(project_conf['service_base_name'], os.environ['project_tag'])
    ...
    project_conf['dataengine_instances_name'] = '{}-{}-dataengine' \
        .format(project_conf['service_base_name'], os.environ['project_tag'])
    project_conf['notebook_dataengine_role_name'] = '{}-{}-nb-de-Role' \
        .format(project_conf['service_base_name'].lower().replace('-', '_'), os.environ['project_tag'])
    ...
    fname = "{}{}.pub".format(os.environ['conf_key_dir'], project_conf['admin_keyname'])
    print(fname)
    ...
    tag = {"Key": project_conf['tag_name'],
           "Value": "{0}-{1}-subnet".format(project_conf['service_base_name'], project_conf['project_tag_value'])}
    ...
    try:
        ...
        params = '--bucket_name {} --ssn_bucket_name {} --shared_bucket_name {} --username {} --edge_role_name {} ' \
                 ...
                 '--user_predefined_s3_policies "{}"'.format(project_conf['bucket_name'], project_conf['ssn_bucket_name'],
                                                             ...
                                                             os.environ['project_tag'], project_conf['edge_role_name'],
        ...
        remove_sgroups(project_conf['notebook_instance_name'])
        remove_sgroups(project_conf['edge_instance_name'])
        remove_s3('edge', os.environ['project_tag'])
        sys.exit(1)
