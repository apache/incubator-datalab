...
parser.add_argument('--cloud_provider', type=str,
                    help='Where Data Lab should be deployed. Available options: aws, azure')
parser.add_argument('--infrastructure_tag', type=str, help='unique name for Data Lab environment')
...
parser.add_argument('--datalab_dir', type=str, help='The path to Data Lab dir')
parser.add_argument('--datalab_id', type=str, default='resource_tags_user_user_tag', help='Column name in report file that contains Data Lab id tag')
...
parser.add_argument('--resource_id', type=str, default='line_item_resource_id', help='Column name in report file that contains Data Lab resource id tag')
...
parser.add_argument('--os_user', type=str, help='Data Lab user')
...
def yml_billing(path):
    try:
        ...
        if args.cloud_provider == 'aws':
            ...
            config_orig = config_orig.replace('DATA_LAB_ID', args.datalab_id)
