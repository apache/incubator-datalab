                ...
                if not os.path.isdir("{0}jars/{1}".format(temp_folder, service)):
                    ...
                    for root, dirs, files in os.walk("{0}jars/{1}".format(temp_folder, service)):
                        for filename in files:
                            if os.path.isfile("{0}{1}{2}/{3}".format(args.datalab_path, jars_folder, service, filename)):
                                ...
                                local("cp -P {0}jars/{1}/{2} {3}{4}{1}".format(temp_folder, service, filename, args.datalab_path, jars_folder))
    except:
