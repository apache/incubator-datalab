...
parser.add_argument('--dlab_id', type=str, default="'user:user:tag'", help='')
parser.add_argument('--usage_date', type=str, default='UsageStartDate', help='')
parser.add_argument('--product', type=str, default='ProductName', help='')
parser.add_argument('--usage_type', type=str, default='UsageType', help='')
parser.add_argument('--usage', type=str, default='UsageQuantity', help='')
parser.add_argument('--cost', type=str, default='BlendedCost', help='')
parser.add_argument('--resource_id', type=str, default='ResourceId', help='')
parser.add_argument('--tags', type=str, default='Operation,ItemDescription', help='')
